...
\section{Container and DevOps Basics}
    ...
    \subsubsection{Idea of Microservices}
    The fundamental idea of Microservices is to have small independently deployable software applications. If the load on one part of the application increases, new instances of that service can be deployed to balance to load across all instances. This concept requires a fast and reliable process to create new application instances.\newline
    ...
    Apart from the performance benefits, the presumably main advantage of containers is their scalability.
    \begin{figure}
        \centering
