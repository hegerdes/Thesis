...
First of will be a formal definition of DevOps, a brief description of the emergence and its current state.
    ...
    \subsection{Functionality of the Technologies Used}
