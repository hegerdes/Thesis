...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}[
        ...
        \path [line] (authbackend) -- node [text width=1cm, above,xshift=3.5mm, yshift=-1mm]{Logs} (logdb);
        \path [line] (deviceapi) -- node [text width=1cm, above, xshift=-3.5mm, yshift=-1mm]{Logs} (logdb);
