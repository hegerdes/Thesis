...
\acro{CI}[CI]{\LU{C}{c}ontinuous \LU{I}{i}ntegration}
\acro{CD}[CD]{\LU{C}{c}ontinuous \LU{D}{d}eployment}
\acro{DB}[DB]{\LU{D}{d}atabase}
\acro{DNS}[DNS]{Domain Name System}
\acro{GUI}[GUI]{Graphical User Interface}
\acro{HTTP}[HTTP]{Hypertext Transfer Protocol}
\acro{I/O}[I/O]{\LU{I}{i}nput/\LU{O}{o}utput}
\acro{IaC}[IaC]{\LU{I}{i}nfrastructure-as-\LU{C}{c}ode}
...
\acro{PaaS}[PaaS]{Plattform as a Service}
...
\acro{XAMPP}[XAMPP]{Apache, MariaDB, PHP, Perl}
