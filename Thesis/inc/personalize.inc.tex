...
\newcommand{\myMaintitle}{Practicability analysis of homogeneous development and production environment using Microservice and DevOps tools, supported by practical exemple project implementation}
