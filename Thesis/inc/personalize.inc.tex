...
\newcommand{\myMaintitle}{Analysis of the practicability of a nearly homogeneous development and live environment using Microservice and DevOps tools on the basis of a practical example}
