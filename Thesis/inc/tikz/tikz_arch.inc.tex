...
\begin{figure}[!h]
    ...
    \begin{tikzpicture}[
        ...
        \node[draw,dashed,fit=(authbackend) (deviceapi) , label={[above]\ac{MSA}\\Cluster}] (microcluster) {};
        ...
        \path [line ] (mqttcon) -- node [text width=2cm, align=center, above] {\acs{REST} \acs{API} for} (mqttbroker);
