...
\begin{figure}
    \centering
    \definecolor{host}{RGB}{4, 108, 118}
    \definecolor{docker}{RGB}{6, 150, 162}
    ...
    \begin{tikzpicture}[auto, align=center]
        ...
        % Icons in host
        \node [below of=drive1, yshift=-3.5cm] (hdirve1) {\includegraphics[width=.08\textwidth]{fig/drive1.png}};
        \node [below of=drive2, yshift=-3.5cm] (hdirve2) {\includegraphics[width=.08\textwidth]{fig/drive1.png}};
        \node [below of=drive3, yshift=-3.5cm] (hdirve3) {\includegraphics[width=.08\textwidth]{fig/drive1.png}};
        ...
        % Ports Text
        \node[above of=host, xshift=-3.8cm, yshift=-0.3cm] (port_text){\scriptsize{Exposed Container Ports}};

        % Ports arrows
        \draw [draw,<->] (hport1) |- (1,0.5) |- (port1.west);
        \draw [draw,<->] (hport2) |- (3.5,0.5) |- (port2.west);
        \draw [draw,<->] (hport3) |- (6,0.5) |- (port3.west);
