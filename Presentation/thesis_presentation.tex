  ...
  \begin{table}[]
    \scalebox{0.7}{
      \begin{tabular}{@{}lp{.18\textwidth}p{.12\textwidth}p{.12\textwidth}p{.24\textwidth}p{.18\textwidth}p{.14\textwidth}@{}}
        ...
        Codesand                                                                                                                                             \\box.io & no                                      & NodeJS           & yes/no                     & HTTP - accessible from the web             & restricted for native packages & Free, 30\$, 56\$      \\
        Stackblitz & no                & NodeJS     & no/yes                      & Only WebSockets & no support for native packages & Free, 9\$, 39\$       \\
        Gitpod     & within containers & any        & yes/yes                     & Full TCP/UDP    & any                            & Free, 9\$, 25\$, 39\$ \\
        Code                                                                                                                                                 \\Spaces     & within containers                     & any              & yes/yes                    & Full TCP/UDP                               & any                            & Free, 4\$, 21\$       \\
        Dev                                                                                                                                                  \\Container   & within containers*   & any              & yes/yes                    & Full TCP/UDP                               & any                            & Free, 5*\$, 7*\$, 21*\$               \\
      \end{tabular}
    }
